    ...
    <AnimatePresence>
      {showPopup && (
        ...
        >
          ...
          >
            {/* Main Popup Content */}
            <div className="bg-gradient-to-br from-orange-500 via-purple-600 to-red-500 rounded-3xl overflow-hidden shadow-2xl border-4 border-orange-300">
              {/* Halloween Header */}
              <div className="relative p-6 text-center bg-gradient-to-r from-orange-600 to-purple-700 mt-6">
              ...
              <div className="p-6 bg-white dark:bg-gray-800">
                ...
                <div className="bg-orange-50 dark:bg-orange-900/20 rounded-xl p-4 mb-4">
                  ...
                  <div className="mt-2 bg-green-100 dark:bg-green-900/30 rounded-lg p-2 text-center">
                ...
                <div className="bg-purple-50 dark:bg-purple-900/20 rounded-xl p-4 mb-6">
                  <div className="flex items-center justify-center mb-2">
                    <FiClock className="w-4 h-4 text-purple-600 dark:text-purple-400 mr-2" />
                ...
                <div className="space-y-3">
                  <motion.button
                    ...
                    className="w-full bg-gradient-to-r from-orange-600 to-purple-600 text-white py-3 rounded-xl font-bold flex items-center justify-center gap-2 shadow-lg hover:shadow-xl transition-all cursor-pointer"
                  >
                  ...
                  <button
                    onClick={handleClose}
                    className="w-full border-2 border-orange-200 dark:border-purple-600 text-orange-600 dark:text-orange-400 py-2 rounded-xl font-medium hover:bg-orange-50 dark:hover:bg-purple-900/20 transition-all cursor-pointer"
                  >
                    Maybe Later
                  </button>
                </div>
            ...
            <motion.button
              ...
              whileTap={{ scale: 0.9 }}
              onClick={handleClose}
              className="absolute -top-4 -right-4 bg-white dark:bg-gray-800 rounded-full p-2 shadow-lg border-2 border-orange-300 dark:border-purple-600 text-orange-600 dark:text-orange-400 hover:text-orange-700 dark:hover:text-orange-300 transition-colors"
            >
