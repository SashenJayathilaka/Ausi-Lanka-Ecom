...
const FeaturesSection = () => {
  ...
  return (
    <motion.section
      ...
      className="w-full bg-white dark:bg-gray-900 transition-colors duration-500"
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 md:py-28 relative">
        {/* Background elements */}
        <div className="absolute -top-20 -left-20 w-64 h-64 bg-blue-100 dark:bg-blue-900/20 rounded-full blur-3xl opacity-20 -z-10 transition-colors duration-500"></div>
        <div className="absolute bottom-0 right-0 w-72 h-72 bg-indigo-100 dark:bg-indigo-900/20 rounded-full blur-3xl opacity-15 -z-10 transition-colors duration-500"></div>
          ...
          {features.map((feature, index) => (
            ...
            >
              <div className="h-full bg-white dark:bg-gray-800 rounded-2xl shadow-lg dark:shadow-gray-950/50 overflow-hidden border border-gray-100 dark:border-gray-700 hover:shadow-xl dark:hover:shadow-gray-950/70 transition-all duration-300">
                <div
                  className={`${feature.color} p-6 flex justify-center transition-colors duration-500`}
                >
                  <motion.div
                    variants={fadeIn("down", 0.4 * (index + 1))}
                    className={`w-20 h-20 rounded-2xl ${feature.color} flex items-center justify-center group-hover:rotate-6 transition-all duration-300`}
                  >
                    <motion.div
                ...
                <div className="p-6 pt-0">
                  ...
                  <motion.p
                    ...
                    className="text-gray-600 dark:text-gray-400 mb-4 transition-colors duration-500"
                  >
                    {feature.description}
                  </motion.p>
                  <motion.a
        ...
        <motion.div variants={fadeIn("up", 0.7)} className="text-center">
          ...
          >
            ...
            <div className="absolute -z-0 w-full h-full rounded-xl bg-blue-600/30 dark:bg-blue-700/30 blur-xl top-0 left-0 group-hover:opacity-70 transition-opacity"></div>
            <div className="absolute inset-0 rounded-xl border-2 border-white/10"></div>
          </motion.button>

          <motion.p
            variants={fadeIn("up", 0.9)}
            className="text-gray-500 dark:text-gray-400 mt-6 text-sm transition-colors duration-500"
          >
