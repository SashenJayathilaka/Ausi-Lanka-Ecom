        ...
        <div className="flex flex-col lg:flex-row gap-8">
          ...
          <div className="lg:w-1/3">
            ...
            >
              ...
              <div className="max-w-md mx-auto bg-white dark:bg-gray-800 rounded-xl shadow-md">
                <div className="mb-6">
                  <label
                    htmlFor="mobile"
                    className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1"
                  ...
                  <div className="relative flex">
                    ...
                    <input
                      ...
                      className="block w-full rounded-lg border border-gray-300 dark:border-gray-600 shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 bg-white dark:bg-gray-700 text-gray-800 dark:text-gray-200 py-3 pl-11 pr-4 transition-colors duration-200"
              ...
              <div className="mb-6">
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div className="h-full">
                    ...
                    <label
                      htmlFor="sea-cargo"
                      className={`flex flex-col items-center justify-center p-4 border rounded-lg cursor-pointer transition-colors duration-200 h-full ${
