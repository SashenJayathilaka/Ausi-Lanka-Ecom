...
const OrderDetailsContent = ({ orderId }: { orderId: string }) => {
  ...
  return (
    <div className="max-w-6xl mx-auto px-6 py-20 bg-white rounded-lg shadow-md mt-24 mb-24">
      <div className="relative z-0">
        ...
        <div className="mb-8 p-4 border border-gray-200 rounded-lg">
          <h2 className="text-lg font-semibold mb-3 text-gray-700 underline">
            Customer Information
          </h2>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div>
              ...
              <p className="font-semibold">{order.user?.emailId}</p>
            </div>
          </div>
        </div>
        ...
        <div className="mb-8 p-4 border border-gray-200 rounded-lg">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div>
              ...
              <p className="capitalize font-semibold">{order.deliveryMethod}</p>
            </div>
            <div>
...
const OrderDetailsSkeleton = () => {
  return (
    <div className="max-w-6xl mx-auto p-6 bg-white rounded-lg shadow-md animate-pulse">
      {/* Header Skeleton */}
      <div className="flex justify-between items-start mb-6">
      ...
      <div className="mb-8 space-y-4">
        ...
        {[...Array(3)].map((_, i) => (
          ...
          >
            <div className="md:w-1/6 h-32 bg-gray-200 rounded"></div>
